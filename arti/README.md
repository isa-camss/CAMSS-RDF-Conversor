...
<h2><center>Compatible with EIF(v6), MSP(v5) and TS(v5) CAMSS Assessment Solutions</center></h2>
...
<p>The arti folder should contain the 'in' (input) and 'out' (output) folders. The 'in' folder will contain:
	<ul>
		<li><b>'in' folder:</b> the user must create a folder named 'in'; once the 'in' folder has been created, the user has to create three other folders named 'EIF600', 'MSP500' and 'TS500' that will contain the EUSurvey output in XLS format.</li>
